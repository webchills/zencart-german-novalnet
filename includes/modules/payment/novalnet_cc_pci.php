...
class novalnet_cc_pci {
	...
	function novalnet_cc_pci(){ 
		...
		$this->key			= MODULE_PAYMENT_NOVALNET_CC_PCI_PASSWORD;
  ...
  function process_button(){
		...
		list($auth_code, $product_id, $tariff_id, $amount, $test_mode, $uniqid, $hash) = $this->encodeParams($auth_code=MODULE_PAYMENT_NOVALNET_CC_PCI_AUTH_CODE, $product_id, $tariff_id, $amount, $test_mode, $uniqid);
	   ...
	   $process_button_string = zen_draw_hidden_field('vendor_id', MODULE_PAYMENT_NOVALNET_CC_PCI_VENDOR_ID) .
							    zen_draw_hidden_field('product_id', $product_id) .
							    zen_draw_hidden_field('payment_id', '6') .
							    ...
							    zen_draw_hidden_field('birthday', $customer['customers_dob']) .
  ...
  function after_process(){
		...
		if($_POST['tid'] != ''){
			...
			$urlparam .= '&auth_code='.MODULE_PAYMENT_NOVALNET_CC_PCI_AUTH_CODE.'&status=100&tid='.$_POST['tid'].'&reference=BNR-'.$insert_id.'&vwz2='.MODULE_PAYMENT_NOVALNET_CC_PCI_TEXT_ORDERNO.''.$insert_id.'&vwz3='.MODULE_PAYMENT_NOVALNET_CC_PCI_TEXT_ORDERDATE.''.date('Y-m-d H:i:s');
  ...
  function install() 
  {
		...
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Test Mode', 'MODULE_PAYMENT_NOVALNET_CC_PCI_TEST_MODE', 'True', 'Do you want to enable the test mode?', '6', '2', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");

		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Please contact sales@novalnet.de if you do not have any of the following Novalnet IDs!<BR><P>Wenn Sie keine oder irgendeine der folgenden Novalnet IDs nicht haben sollten, bitte sich an sales@novalnet.de wenden!<BR><P>Novalnet Merchant ID', 'MODULE_PAYMENT_NOVALNET_CC_PCI_VENDOR_ID', '', 'Your Merchant ID of Novalnet', '6', '3', now())");

		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Novalnet Authorisation Code', 'MODULE_PAYMENT_NOVALNET_CC_PCI_AUTH_CODE', '', 'Your Authorisation Code of Novalnet', '6', '4', now())");
			
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Novalnet Product ID', 'MODULE_PAYMENT_NOVALNET_CC_PCI_PRODUCT_ID', '', 'Your Product ID of Novalnet', '6', '5', now())"); 

		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Novalnet Tariff ID', 'MODULE_PAYMENT_NOVALNET_CC_PCI_TARIFF_ID', '', 'Your Tariff ID of Novalnet', '6', '6', now())");
    
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Manual checking amount in cents', 'MODULE_PAYMENT_NOVALNET_CC_PCI_MANUAL_CHECK_LIMIT', '', 'Please enter the amount in cents', '6', '7', now())");    

		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Your second Product ID in Novalnet', 'MODULE_PAYMENT_NOVALNET_CC_PCI_PRODUCT_ID2', '', 'for the manual checking', '6', '8', now())"); 

		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('The Tariff ID of the second product', 'MODULE_PAYMENT_NOVALNET_CC_PCI_TARIFF_ID2', '', 'for the manual checking', '6', '9', now())");

		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Enter password here', 'MODULE_PAYMENT_NOVALNET_CC_PCI_PASSWORD', '', 'for the manual checking', '6', '10', now())");
		
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Your Booking Reference at Novalnet', 'MODULE_PAYMENT_NOVALNET_CC_PCI_BOOK_REF', '', 'Your Booking Reference at Novalnet', '6', '11', now())");
		
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort order of display.', 'MODULE_PAYMENT_NOVALNET_CC_PCI_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '12', now())");
