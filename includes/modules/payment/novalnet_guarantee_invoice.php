<?php
/**
* This script is used for Guaranteed Invoice payment
*
* @author Novalnet AG
...
class novalnet_guarantee_invoice {
    ...
    /**
     * Function : novalnet_guarantee_invoice()
     *
     */
   ...
   /**
     ...
     */
    function keys() {
        echo '<script src="'.DIR_WS_CATALOG.'includes/ext/novalnet/js/novalnet_admin.js" type="text/javascript"></script>';
