...
class novalnet_payments extends base {
	...
	*/
	...
	public function install() {
        ...
        $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Payment access key', 'MODULE_PAYMENT_NOVALNET_PAYMENT_ACCESS_KEY', '', 'Get your Payment access key from the <a href=https://admin.novalnet.de target=_blank style=text-decoration: underline; font-weight: bold; color:#0080c9;>Novalnet Admin Portal</a> Project > Choose your project > API credentials >Payment access key', '6', '0', now())");
        ...
        $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,set_function, date_added) VALUES ('Display payment method', 'MODULE_PAYMENT_NOVALNET_ENABLE_PAYMENT_METHOD', 'False', '', '6', '0', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
        ...
        $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('<script src=../includes/modules/payment/novalnet/novalnet_auto_config.js type=text/javascript></script> <input type=button id=webhook_url_button style=font-weight: bold; color:#0080c9; value=Configure> <br> <br> Send e-mail to', 'MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_TO', '', 'Notification / Webhook URL execution messages will be sent to this e-mail', '6', '0', now())");
