...
#########################################################
  ...
  define('MODULE_PAYMENT_NOVALNET_CC_TEXT_TITLE', '<NOBR><A HREF="http://www.novalnet.de" TARGET="_new"><IMG SRC="images/NN_Logo_T.png" ALT="Payment - Novalnet AG" BORDER="0"></A>&nbsp;Credit Card </NOBR>');
