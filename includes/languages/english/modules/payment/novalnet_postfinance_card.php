...
define('MODULE_PAYMENT_NOVALNET_POSTFINANCE_CARD_TEXT_DESCRIPTION', '<br>You will be redirected to PostFinance. Please don&#39;t close or refresh the browser until the payment is completed<br/>');
