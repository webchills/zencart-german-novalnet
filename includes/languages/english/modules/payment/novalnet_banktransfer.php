...
define('MODULE_PAYMENT_NOVALNET_BANKTRANSFER_TEXT_TITLE', 'Sofort');
define('MODULE_PAYMENT_NOVALNET_BANKTRANSFER_TEXT_DESCRIPTION', '<br>You will be redirected to Sofort. Please don&#39;t close or refresh the browser until the payment is completed <br />');
