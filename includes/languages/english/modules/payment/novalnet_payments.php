...
define('MODULE_PAYMENT_NOVALNET_ENABLE_PAYMENT_METHOD_TITLE', 'Enable payment method');
define('MODULE_PAYMENT_NOVALNET_ENABLE_PAYMENT_METHOD_DESCRIPTION', 'Do you want to enable payments via Novalnet?');
...
define('MODULE_PAYMENT_NOVALNET_GLOBAL_CONFIG_TEXT_TITLE','Novalnet API Configuration (V_13.0.0)');
...
define('MODULE_PAYMENT_NOVALNET_ORDER_CAPTURE_MAIL_SUBJECT', 'Order Confirmation - Your Order %s with %s has been confirmed!');
