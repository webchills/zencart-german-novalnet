...
define('MODULE_PAYMENT_NOVALNET_BANKTRANSFER_TEXT_TITLE', 'Sofortüberweisung');
define('MODULE_PAYMENT_NOVALNET_BANKTRANSFER_TEXT_DESCRIPTION', '<br>Sie werden zu Sofortüberweisung weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist<br />');
