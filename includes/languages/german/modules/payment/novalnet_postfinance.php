...
define('MODULE_PAYMENT_NOVALNET_POSTFINANCE_TEXT_TITLE', 'PostFinance');
define('MODULE_PAYMENT_NOVALNET_POSTFINANCE_TEXT_DESCRIPTION', '<br> Sie werden zu PostFinance weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist<br/>');
